...
-- Head     : {{schema}}.{{headTable}}
-- Line     : {{schema}}.{{lineTable}}
...
{{line_unnest_aliases}}
    ...
    ELSIF pi_opflag = 'M' THEN
        ...
        SELECT * FROM {{schema}}.{{headTable}} WHERE 1 = 2;
...
{{update_business_assignments}}
        ...
        SELECT * FROM {{schema}}.{{lineTable}} WHERE 1 = 2;
